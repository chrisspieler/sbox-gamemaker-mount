// Stolen from SharpZipLib
// https://github.com/icsharpcode/SharpZipLib/blob/master/src/ICSharpCode.SharpZipLib/Checksum/CrcUtilities.cs
...
internal static class CrcUtilities
{
	...
	/// </remarks>
	[MethodImpl( MethodImplOptions.AggressiveInlining )]
	private static uint UpdateDataCommon( byte[] input, int offset, uint[] crcTable, byte x1, byte x2, byte x3,
		byte x4 )
	{
		uint result;

...
public record AudioChunk( ArchiveData ChunkData, string Magic, int ElementCount, int[] ElementOffsets )
	: ArchiveListChunk<AudioChunk.Record>( ChunkData, Magic, ElementCount, ElementOffsets )
{
